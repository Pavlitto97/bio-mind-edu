...
**Acceptance Criteria**:
- [ ] При tap на части модели показывается аннотация
- [ ] Аннотации позиционируются корректно
- [ ] Воспроизводится соответствующее audio
- [ ] UI аннотаций адаптивен
- [ ] Работает в AR и fallback mode
